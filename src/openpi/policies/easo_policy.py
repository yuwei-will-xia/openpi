...
def make_easo_example() -> dict:
    ...
    return {
        ...
        "timestamp": np.random.randint(1000000000),
    }
...
class EasoInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        state = transforms.pad_to_dim(data["observation/joint_angles"], self.action_dim)
        ...
        wrist_image = _parse_image(data["observation.images.wrist_camera_right"])
